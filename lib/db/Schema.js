...
class Schema
{
   ...
   * @param {boolean} [options.isEnforceDefinition] - Indicates if `definition` will be enforced or not. Default is `true`.
   */
  constructor (dbName, collectionName, definition = undefined, options = undefined)
  {
    ...
    {
      utility.init(this._definition.properties, {});
      utility.init(this._definition.required, []);
