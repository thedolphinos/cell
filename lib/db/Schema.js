...
class Schema
{
  ...
  {
    Schema._validateConstructorParameters(dbName, collectionName, definition);
  ...
  /**
   * Generates JSON schema for MongoDB using definition.
   *
   * @since 0.36.0
   * @return {Object}
   * @private
   ...
   * @protected
   */
  static _validateConstructorParameters (dbName, collectionName, definition)
  {
