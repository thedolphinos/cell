...
class DbOperation
{
  ...
  constructor (schema)
  {
    DbOperation._validateConstructorParameters(schema);
  ...
  /**
   * Partially updates the first matching document with the specified query and options by using the specified document candidate.
   ...
   */
  async partialUpdateOne (query, newDocumentPropertyCandidates, options = {})
  {
    if (!_.isPlainObject(query) ||
    ...
    const keys = Object.keys(newDocumentPropertyCandidates);
