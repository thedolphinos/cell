...
const DEFAULT_ROUTE_PATHS = Object.freeze({
                                            ...
                                            READ_ONE_BY_ID: "/:id",
                                            CREATE_ONE: "",
                                            UPDATE_ONE_BY_ID_AND_VERSION: "/:id",
...
class RouteHelper
{
  ...
  static generateRoutes (router, authController, controller, routes)
  {
    ...
    if (routeNames.includes(ROUTE_NAME.PARTIAL_UPDATE_ONE_BY_ID_AND_VERSION))
    {
      ...
      router.route(routes.UPDATE_ONE_BY_ID_AND_VERSION).patch((request, response) => controller.partialUpdateOneByIdAndVersion(request, response));
    }
