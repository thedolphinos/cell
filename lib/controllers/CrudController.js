...
class CrudController extends Controller
{
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  this._addValueToParentRoutes(parentRouteValues)
                                  documents = await this._controllerService.read(query, session, parentRoutes);
  ...
  /**
   * Adds the corresponding value to parent route.
   *
   * !!! Works on reference.
   *
   * @param {Array<string>} parentRouteValues
   * @private
   */
  _addValueToParentRoutes (parentRouteValues)
  {
    for (const parentRoute of this._parentRoutes)
    {
