...
class CrudController extends Controller
{
   ...
   * @param {Array<{pathParameter: string}>} [options.parentRoutes] - The order of the parent routes are important. The preceding path comes first in the URL.
   */
  ...
  _validateConstructorParams (service, options)
  {
    ...
    if (!(service instanceof ControllerService) ||
        ...
        (utility.isExist(parentRoutes) && !_.isArray(parentRoutes)))
    {
      throw new InvalidArgumentsError();
    }
