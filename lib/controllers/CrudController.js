      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  documents = await this._controllerService.search(query, searchValue, searchFields, session, {bearer: hooks.bearer});
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  documents = await this._controllerService.read(query, undefined, session, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(documents, session) : undefined;
                                }, undefined, session);
