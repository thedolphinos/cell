...
class CrudController extends Controller
{
  ...
  constructor (controllerService, options = undefined)
  {
    ...
    if (utility.isExist(options.parentRoutes))
    {
      Validator.validateParentRoutes(options.parentRoutes);
    }
  ...
  async read (request, response, next = undefined, hooks = undefined, allowedProperties = undefined)
  {
    try
    {
      ...
      const parentRouteValues = utility.isInitialized(this._parentRoutes) ? this._extractParentRouteParameters(pathParameters) : undefined;
      ...
      {
        throw new BadRequestError({en: "Query must be valid JSON."});
      }
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  documents = await this._controllerService.read(query, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  document = await this._controllerService.readOneById(_id, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  document = await this._controllerService.createOne(body, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(document) : undefined;
                                }, undefined, session);
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  document = await this._controllerService.updateOneByIdAndVersion(_id, version, body, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(document) : undefined;
                                }, undefined, session);
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  utility.isExist(hooks.before) ? await hooks.before(_id, version, body) : undefined;
                                  document = await this._controllerService.replaceOneByIdAndVersion(_id, version, body, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(document) : undefined;
                                }, undefined, session);
      ...
      await SessionManager.exec(async () =>
                                {
                                  ...
                                  document = await this._controllerService.softDeleteOneByIdAndVersion(_id, version, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(document) : undefined;
                                }, undefined, session);
  ...
  async deleteOneByIdAndVersion (request, response, next = undefined, hooks = undefined, allowedProperties = undefined)
  {
    try
    {
      ...
      await SessionManager.exec(async () =>
                                {
                                  utility.isExist(hooks.before) ? await hooks.before(_id, version) : undefined;
                                  document = await this._controllerService.deleteOneByIdAndVersion(_id, version, session, this._parentRoutes, parentRouteValues, {bearer: hooks.bearer});
                                  utility.isExist(hooks.after) ? await hooks.after(document) : undefined;
                                }, undefined, session);
