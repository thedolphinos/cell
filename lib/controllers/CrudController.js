...
{
  /**
   * Represents allowed request element keys.
   *
   * @type {Array<string>}
   * @public
   */
  static ALLOWED_REQUEST_ELEMENT_KEYS = [
    "headers",
    "pathParameters",
    "queryString",
    "body"
   ...
   * @param {{[headers]: AllowedProperties, [pathParameters]: AllowedProperties, [queryString]: AllowedProperties, [body]: AllowedProperties}} [allowedPropertiesForRequestElements] - Represents allowed properties for request elements.
   * @return {Promise<void>}
   */
