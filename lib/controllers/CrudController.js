...
class CrudController extends Controller
{
   ...
   * @return {Promise<void>}
   */
  async updateOneById (request, response, next = null)
  {
    try
    {
      CrudController.validateControllerParameters(request, response, next);
      ...
      const body = CrudController.extractBody(request);
      const result = await this._service.updateOneById(id, version, body);
      CrudController.sendResponse(response, 201, result);
    }
    catch (error)
    {
   ...
   * @return {Promise<void>}
   */
  async deleteOneById (request, response, next = null)
  {
    try
    {
      CrudController.validateControllerParameters(request, response, next);
      const id = CrudController.extractPathParameter(request, "id");
      const version = CrudController.extractQueryStringParameter(request, "version");
      const result = await this._service.deleteOneById(id, version);
      CrudController.sendResponse(response, 201, result);
    }
    catch (error)
    {
   ...
   * @return {Promise<void>}
   */
  async deleteOneSoftById (request, response, next = null)
  {
    try
    {
      CrudController.validateControllerParameters(request, response, next);
      const id = CrudController.extractPathParameter(request, "id");
      const version = CrudController.extractQueryStringParameter(request, "version");
      const result = await this._service.deleteOneSoftById(id, version);
      CrudController.sendResponse(response, 201, result);
    }
    catch (error)
    {
