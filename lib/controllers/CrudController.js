...
class CrudController extends Controller
{
   ...
   */
  constructor (controllerService, allowedProperties = DEFAULT_ALLOWED_PROPERTIES, isAllowedPropertiesComplete = true)
  {
    super();
    ...
    this._allowedProperties = isAllowedPropertiesComplete ? allowedProperties : _.union(DEFAULT_ALLOWED_PROPERTIES, allowedProperties);
  }
   ...
   * @return {Promise<void>}
   */
  async read (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.READ])
  {
    try
    {
   ...
   * @return {Promise<void>}
   */
  async readOneById (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.READ_ONE_BY_ID])
  {
    try
    {
      this._validateControllerParams(request, response, next);
   ...
   * @return {Promise<void>}
   */
  async createOne (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.CREATE_ONE])
  {
    try
    {
      this._validateControllerParams(request, response, next);
   ...
   * @return {Promise<void>}
   */
  async updateOneByIdAndVersion (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.UPDATE_ONE_BY_ID_AND_VERSION])
  {
    try
    {
      this._validateControllerParams(request, response, next);
   ...
   * @return {Promise<void>}
   */
  async replaceOneByIdAndVersion (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.REPLACE_ONE_BY_ID_AND_VERSION])
  {
    try
    {
      this._validateControllerParams(request, response, next);
   ...
   * @return {Promise<void>}
   */
  async softDeleteOneByIdAndVersion (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.SOFT_DELETE_ONE_BY_ID_AND_VERSION])
  {
    try
    {
      this._validateControllerParams(request, response, next);
   ...
   * @return {Promise<void>}
   */
  async deleteOneByIdAndVersion (request, response, next = null, hooks = {}, allowedProperties = this._allowedProperties[METHOD_IDENTIFIER.DELETE_ONE_BY_ID_AND_VERSION])
  {
    try
    {
      this._validateControllerParams(request, response, next);
  ...
  _validateConstructorParams (service, allowedProperties, isAllowedPropertiesComplete)
  {
    if (!(service instanceof ControllerService) ||
        ...
        Object.keys(allowedProperties).length !== Object.keys(METHOD_IDENTIFIER).length ||
