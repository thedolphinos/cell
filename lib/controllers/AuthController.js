...
class AuthController extends Controller
{
   ...
   * @return {Promise<void>}
   */
  async verify (request, response, next, hooks = undefined, allowedProperties = undefined)
  {
    try
    {
      hooks = utility.init(hooks, {});
      ...
      utility.isExist(hooks.headers) ? await hooks.payload(headers) : undefined;
      ...
      const account = await this._applicationService.readOneById(decodedToken.data._id, undefined, {bearer: hooks.bearer});
