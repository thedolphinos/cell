...
class AuthController extends Controller
{
      ...
      await session.withTransaction(async () =>
                                    {
                                      ...
                                      {
                                        httpError = new ForbiddenError(403, "The account is already exist.");
                                        return;
                                      }
  ...
  async _processVerify (authorizationHeader, locals)
  {
    ...
    try
    {
      ...
      this._hook_processVerify_afterDecodeToken(decodedToken, locals);
    }
    catch (error)
    {
   ...
   * @protected
   */
  _hook_processVerify_afterDecodeToken (decodedToken, locals)
  {
