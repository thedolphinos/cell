      ...
      await session.withTransaction(async () =>
                                    {
                                      ...
                                      await this._hook_processRegister_beforeCreateOperation(body, accountCandidate, session);
                                      data.account = await this._applicationService.createOne(accountCandidate, session);
                                      await this._hook_processRegister_afterCreateOperation(data.account, session);
