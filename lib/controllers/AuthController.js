...
class AuthController extends Controller
{
   ...
   * @returns {string}
   */
  get privateKeyForEncryption ()
  {
    return this._privateKeyForEncryption;
  }
   ...
   * @returns {string}
   */
  get initVectorForEncryption ()
  {
    return this._initVectorForEncryption;
  }
  ...
  _generateToken (payload)
  {
    ...
    const cipher = crypto.createCipheriv(AuthController.DEFAULT_ENCRYPTION_ALGORITHM, this._privateKeyForEncryption, this._initVectorForEncryption)
  ...
  _decodeToken (encodedToken)
  {
    ...
    const decipher =  crypto.createDecipheriv(AuthController.DEFAULT_ENCRYPTION_ALGORITHM, this._privateKeyForEncryption, this._initVectorForEncryption)
