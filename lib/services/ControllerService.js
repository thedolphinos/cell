...
class ControllerService extends Service
{
   ...
   */
  async read (queryString, externalSession = null, hooks = {}, parentRoutes = {})
  {
   ...
   */
  async readOneById (_id, externalSession = null, hooks = {}, parentRoutes = {})
  {
    this._validateParameterSession(externalSession);
    this._validateParameterHooks(hooks);
   ...
   */
  async createOne (body, externalSession = null, hooks = {}, parentRoutes = {})
  {
   ...
   */
  async updateOneByIdAndVersion (_id, version, documentCandidate, externalSession = null, hooks = {}, parentRoutes = {})
  {
   ...
   * @return {Promise<Object>}
   */
  async replaceOneByIdAndVersion (_id, version, documentCandidate, externalSession = null, hooks = {}, parentRoutes = {})
  {
    this._validateParameterDocumentCandidate(documentCandidate);
    this._validateParameterSession(externalSession);
    this._validateParameterHooks(hooks);
   ...
   */
  async softDeleteOneByIdAndVersion (_id, version, externalSession = null, hooks = {}, parentRoutes = {})
  {
    this._validateParameterSession(externalSession);
    this._validateParameterHooks(hooks);
   ...
   */
  async deleteOneByIdAndVersion (_id, version, externalSession = null, hooks = {}, parentRoutes = {})
  {
    this._validateParameterSession(externalSession);
    this._validateParameterHooks(hooks);
