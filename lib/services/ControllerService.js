...
class ControllerService extends Service
{
  ...
  async updateOneByIdAndVersion (_id, version, documentCandidate, session = null, hooks = {})
  {
    ...
    this._authorizeDocumentCandidate(documentCandidate, this.applicationService.dbOperation.schema.definition, Schema.CONTROLLER_OPERATION.updateOneByIdAndVersion);
    documentCandidate = this._validateAndConvertDocumentCandidate(documentCandidate, this.applicationService.dbOperation.schema.definition);
  ...
  async replaceOneByIdAndVersion (_id, version, documentCandidate, session = null, hooks = {})
  {
    ...
    _id = this._validateAndConvertObjectIdCandidate(_id);
    version = this._validateAndConvertVersion(version);
    this._authorizeDocumentCandidate(documentCandidate, this.applicationService.dbOperation.schema.definition, Schema.CONTROLLER_OPERATION.replaceOneByIdAndVersion);
    documentCandidate = this._validateAndConvertDocumentCandidate(documentCandidate, this.applicationService.dbOperation.schema.definition);
