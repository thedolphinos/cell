    ...
    await SessionManager.exec(async () =>
                              {
                                ...
                                if (utility.isInitialized(parentRoutes))
                                {
                                  ...
                                  for (let i = 0; i < parentRoutes.length; i++)
                                  {
                                    ...
                                    body[parentRoute.pathParameter] = parentRoute.value;
                                  }
                                }
    ...
    await SessionManager.exec(async () =>
                              {
                                ...
                                if (utility.isInitialized(parentRoutes))
                                {
                                  ...
                                  const document = this.applicationService.readOne(query, session);

                                  if (!utility.isExist(document))
                                  {
                                    throw new BadRequestError("No such document.");
                                  }
                                }
