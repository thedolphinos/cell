...
class ControllerService extends Service
{
   ...
   */
  async search (query, searchValue, searchFields, externalSession = undefined, hooks = undefined)
  {
    ...
    await SessionManager.exec(async () =>
                              {
                                ...
                                documents = await this.dbOperation.read(convertedQuery, utility.isExist(session) ? {session} : undefined);
