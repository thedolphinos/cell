...
class ApplicationService extends Service
{
  ...
  async softDeleteOne (query, options = {}, hooks = {})
  {
    ...
    return await this.updateOne(query, this._generateDocumentPropertyCandidatesForSoftDelete(), options, hooks);
  }
  ...
  async softDeleteOneByIdAndVersion (_id, version, options = {}, hooks = {})
  {
    ...
    return await this.updateOneByIdAndVersion(_id, version, this._generateDocumentPropertyCandidatesForSoftDelete(), options, hooks);
  }
