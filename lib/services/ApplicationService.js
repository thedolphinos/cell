...
class ApplicationService extends Service
{
   ...
   * @param {boolean} [raiseDocumentExistenceErrors]
   */
  constructor (schema_dbOperation_dbService, raiseDocumentExistenceErrors = undefined)
  {
    raiseDocumentExistenceErrors = utility.init(raiseDocumentExistenceErrors, false);
    ...
    if (!_.isBoolean(raiseDocumentExistenceErrors))
    {
      throw new InvalidArgumentsError();
    }

    this._raiseDocumentExistenceErrors = raiseDocumentExistenceErrors;
