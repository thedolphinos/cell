...
class ApplicationService extends Service
{
  ...
  async read (query, externalSession = null, hooks = {})
  {
    ...
    query = Service.validateAndConvertCandidate(query, this.schema.definition, null, this._layer);
  ...
  async readOne (query, externalSession = null, hooks = {}, hooksOfSpecializedVersion = {})
  {
    ...
    if (!this._muteDbErrors && !utility.isExist(document))
    {
  ...
  async createOne (documentCandidate, externalSession = null, hooks = {})
  {
    ...
    documentCandidate = Service.validateAndConvertCandidate(documentCandidate, this.schema.definition, null, this._layer);
  ...
  /* GET/SET */
  /**
   * @param {boolean} muteDbErrors
   */
  set muteDbErrors (muteDbErrors)
  {
    if (!_.isBoolean(muteDbErrors))
    {
      throw new InvalidArgumentsError();
    }

    this._muteDbErrors = muteDbErrors;
  }
