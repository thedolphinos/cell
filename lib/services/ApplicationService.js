...
class ApplicationService extends Service
{
  ...
  async read (query, externalSession = null, hooks = {})
  {
    ...
    query = Service.validateAndConvertCandidate(query, this.schema.definition, this._layer);
  ...
  async createOne (documentCandidate, externalSession = null, hooks = {})
  {
    ...
    documentCandidate = Service.validateAndConvertCandidate(documentCandidate, this.schema.definition, this._layer);
