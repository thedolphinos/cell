...
class Service
{
   ...
   */
  static validateAndConvertCandidate (candidate, schemaDefinition, convertedCandidate = null, layer = null)
  {
   ...
   * @return {Int32 | number}
   */
  static validateAndConvertIntCandidate (candidate, layer = null)
  {
    if (!utility.isExist(candidate))
    {
      return null;
   ...
   */
  static validateAndConvertDoubleCandidate (candidate, layer = null)
  {
    if (!utility.isExist(candidate))
    {
      return null;
   ...
   * @return {Object}
   */
  static validateAndConvertObjectCandidate (candidate, schemaDefinition, convertedCandidate = null, layer = null)
  {
    if (!utility.isExist(candidate))
    {
      return null;
   ...
   * @param {string} [layer]
   */
  static validateMultilingualCandidate (candidate, definition, convertedCandidate, layer = null)
  {
    if (!_.isPlainObject(candidate) ||
   ...
   * @return {Array}
   */
  static validateAndConvertArrayCandidate (candidate, schemaDefinition, convertedCandidate = null, layer = null)
  {
    if (!utility.isExist(candidate))
    {
      return null;
