...
class Service
{
  ...
  async createOne (documentCandidate, options = {})
  {
    ...
    documentCandidate = this.validateAndProcessDocumentCandidate(documentCandidate);
    documentCandidate = {
      ...documentCandidate,
      version: 0,
      isSoftDeleted: false
   ...
   */
  validateAndProcessDocumentCandidate (candidate, schemaDefinition = this._dbService.schema.definition, generatedCandidate = null)
  {
    ...
    for (let i = 0; i < keys.length; i++)
    {
      ...
      switch (schemaDefinition.properties[key].bsonType)
      {
        ...
        case Schema.DataType.Date:
          ...
          break;
        case Schema.DataType.Object:
          generatedCandidate[key] = this.validateAndProcessDocumentCandidate(value, schemaDefinition.properties[key], generatedCandidate[key]);
          break;
        case Schema.DataType.Array:
    ...
    for (let i = 0; i < candidate.length; i++)
    {
      ...
      switch (schemaDefinition.items.bsonType)
      {
        ...
        case Schema.DataType.Object:
          ...
          this.validateAndProcessDocumentCandidate(value, schemaDefinition.items, generatedCandidate[generatedCandidate.length - 1]);
          break;
        case Schema.DataType.Array:
