...
class Service
{
  ...
  static validateMultilingualCandidate (candidate, definition, convertedCandidate, layer = undefined)
  {
    ...
    for (const language in candidate)
    {
      ...
      {
        throw new BadRequestError({en: `Either you did not send a language identifier to a multilingual field or you have sent an identifier which is not available.`});
      }
