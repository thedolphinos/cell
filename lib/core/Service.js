...
class Service
{
  ...
  async createOne (rawDocumentCandidate, options = {})
  {
    ...
    try
    {
      let documentCandidate = this.generateDocumentCandidate(rawDocumentCandidate);
      documentCandidate = {
        ...documentCandidate,
        version: 0,
        isDeleted: false
  ...
  async updateOne (query, rawDocumentCandidate, options = {})
  {
    ...
    try
    {
          ...
          await session.withTransaction(async () =>
                                        {
                                          ...
                                          result = await this._dbService.getNativeOps().findOneAndUpdate({_id: documents[0]._id}, {$set: {...documentCandidate, version: documents[0].version + 1}}, {
                                            ...options,
                                            session,
      ...
      else
      {
        ...
        const result = await this._dbService.getNativeOps().findOneAndUpdate({_id: documents[0]._id}, {$set: {...documentCandidate, version: documents[0].version + 1}}, {
          ...options,
          returnOriginal: false
        });
  ...
  async updateOneById (_id, version, rawDocumentCandidate, options = {})
  {
    ...
    try
    {
          ...
          await session.withTransaction(async () =>
                                        {
                                          ...
                                          result = await this._dbService.getNativeOps().findOneAndUpdate({_id}, {$set: {...documentCandidate, version: document.version + 1}}, {
                                            ...options,
                                            session,
                                            returnOriginal: false
                                          });
      ...
      else
      {
        ...
        const result = await this._dbService.getNativeOps().findOneAndUpdate({_id}, {$set: {...documentCandidate, version: document.version + 1}}, {
          ...options,
          session,
          returnOriginal: false
        });
  ...
  /**
   * Deletes the document with the specified ID, version, and options.
   * Uses transactions.
   * See: https://docs.mongodb.com/manual/reference/method/db.collection.findOneAndDelete/
   * See: https://mongodb.github.io/node-mongodb-native/3.6/api/Collection.html#findOneAndDelete
   *
   ...
   * @returns {Promise<Object>} - The deleted document.
   */
  async deleteOneById (_id, version, options = {})
  {
    if (!_.isPlainObject(options))
    {
      throw new InvalidArgumentsError();
    ...
    try
    {
          ...
          await session.withTransaction(async () =>
                                        {
                                          ...
                                          result = await this._dbService.getNativeOps().findOneAndDelete({_id}, {
                                            ...options,
                                            session
                                          });
                                        }, this._dbService.transactionOptions);
      ...
      else
      {
        ...
        const result = await this._dbService.getNativeOps().findOneAndDelete({_id}, {
          ...options,
          session
        });
  ...
  /**
   * Deletes (soft) the 1 and only 1 matching document with the specified query and options.
   * Uses transactions.
   * See: https://docs.mongodb.com/manual/reference/method/db.collection.findOneAndUpdate/
   * See: https://mongodb.github.io/node-mongodb-native/3.6/api/Collection.html#findOneAndUpdate
   *
   ...
   * @returns {Promise<Object>} - The updated document.
   */
  async deleteOneSoft (query, rawDocumentCandidate, options = {})
  {
    if (!_.isPlainObject(query) ||
        !_.isPlainObject(rawDocumentCandidate) ||
        !_.isPlainObject(options))
    ...
    try
    {
          ...
          await session.withTransaction(async () =>
                                        {
                                          ...
                                          result = await this._dbService.getNativeOps().findOneAndUpdate({_id: documents[0]._id}, {$set: {...documentCandidate, version: documents[0].version + 1, isDeleted: true}}, {
                                            ...options,
                                            session,
                                            returnOriginal: false
                                          });
      ...
      else
      {
        ...
        const result = await this._dbService.getNativeOps().findOneAndUpdate({_id: documents[0]._id}, {$set: {...documentCandidate, version: documents[0].version + 1, isDeleted: true}}, {
          ...options,
          returnOriginal: false
        });
  ...
  /**
   * Deletes (soft) the document with the specified ID, version, and options.
   * Uses transactions.
   * See: https://docs.mongodb.com/manual/reference/method/db.collection.updateOne/
   * See: https://mongodb.github.io/node-mongodb-native/3.6/api/Collection.html#updateOne
   *
   ...
   * @returns {Promise<Object>} - The deleted document.
   */
  async deleteOneSoftById (_id, version, options = {})
  {
    if (!_.isPlainObject(options))
    {
      throw new InvalidArgumentsError();
    ...
    try
    {
          ...
          await session.withTransaction(async () =>
                                        {
                                          ...
                                          result = await this._dbService.getNativeOps().findOneAndUpdate({_id}, {$set: {version: document.version + 1, isDeleted: true}}, {
                                            ...options,
                                            session,
                                            returnOriginal: false
                                          });
      ...
      else
      {
        ...
        const result = await this._dbService.getNativeOps().findOneAndUpdate({_id}, {$set: {version: document.version + 1, isDeleted: true}}, {
          ...options,
          session,
          returnOriginal: false
        });
