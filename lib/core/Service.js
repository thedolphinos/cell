...
class Service
{
  ...
  async createOne (documentCandidate, options = {})
  {
    ...
    documentCandidate = this._hookDocumentCandidateForCreateOne(documentCandidate);
    documentCandidate = {
      ...documentCandidate,
      version: 0,
      isSoftDeleted: false
  ...
  async updateOne (query, documentCandidate, options = {})
  {
    ...
    documentCandidate = this._validateAndProcessDocumentCandidate(documentCandidate);
    documentCandidate = this._hookDocumentCandidateForUpdateOne(documentCandidate);
  ...
  async updateOneByIdAndVersion (_id, version, documentCandidate, options = {})
  {
    ...
    documentCandidate = this._validateAndProcessDocumentCandidate(documentCandidate);
    documentCandidate = this._hookDocumentCandidateForUpdateOneByIdAndVersion(documentCandidate);
  ...
  /**
   * Hook for the specified document candidate for the method `createOne`.
  ...
  /**
   * Hook for the specified document candidate for the method `updateOne`.
   * Runs afters the method `_validateAndProcessDocumentCandidate`.
   * Should be overridden.
   *
   * @since 0.20.0
  ...
  /**
   * Hook for the specified document candidate for the method `updateOneByIdAndVersion`.
   * Runs afters the method `_validateAndProcessDocumentCandidate`.
   * Should be overridden.
   *
   * @since 0.20.0
