...
class Service
{
   ...
   * @protected
   */
  _validateAndConvertCandidate (candidate, schemaDefinition, convertedCandidate = null)
  {
    ...
    for (let i = 0; i < candidate.length; i++)
    {
      ...
      switch (schemaDefinition.items.bsonType)
      {
        ...
        case Schema.DataType.Object:
          ...
          this._validateAndConvertCandidate(value, schemaDefinition.items, convertedCandidate[convertedCandidate.length - 1]);
          break;
        case Schema.DataType.Array:
