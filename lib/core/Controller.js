...
class Controller
{
  ...
  async _sendResponse (request, response, statusCode, data = null)
  {
    ...
    if (!utility.isValidNumber(statusCode) || !(Controller.VALID_HTTP_STATUS_CODES.INFORMATIONAL.includes(statusCode) || VALID_HTTP_STATUS_CODES.SUCCESSFUL.includes(statusCode)))
    {
