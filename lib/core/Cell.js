const {
  ...
  DATA: ERROR_DATA_OF_ERROR4JS, StaticClassInstantiationError
...
class Cell
{
  ...
  static async createLife (config = undefined)
  {
    ...
    {
      Cell._validateParameterConfig(config);
    }
  ...
  /**** VALIDATE PARAMETERS ****/
  /**
   * Validates the specified config parameter.
   *
   * @param {Object} config
   ...
   * @static
   */
  static _validateParameterConfig (config)
  {
