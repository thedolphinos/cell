...
class Server
{
  ...
  {
    Server._validateConstructorParameters(requestListener, options);
  ...
  async create ()
  {
    ...
    {
      this._http = http.createServer(null, this._requestListener);
    ...
    {
      this._https = https.createServer(this._options.https.config.sslTlsCertificate, this._requestListener);
   ...
   * @private
   */
  static _validateConstructorParameters (requestListener, options)
  {
